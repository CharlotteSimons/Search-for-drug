        ...
        <TableBodyCell colspan={columns.length} tdClass="bg-red-100 rounded-b-3xl">
          ...
          {#if !reviewed_criteria.includes(identifiable_criterion(criterion))}    
              <div class="bg-white rounded-lg p-1 mb-2 flex flex-row text-md shadow-md">
                <!-- Criterion -->
                <div class="w-4/5 pr-8 ml-2 my-1 flex flex-col">
                  <P>
                ...
                <div class="w-1/5 my-1 mr-2 flex flex-row justify-end space-x-1 items-center">
                <ApiButton color="green" text="Y" disabled={reviewing} onClick={() => review(criterion, true)}></ApiButton>
                <ApiButton color="red" text="X" disabled={reviewing} onClick={() => review(criterion, false)}></ApiButton>
                <ApiButton color="dark" text="?" disabled={reviewing} onClick={() => review(criterion, null)}></ApiButton>
                </div>
