            ...
            {#if !reviewed_criteria.includes(identifiable_criterion(criterion))}
              ...
              <div class="bg-white rounded-lg p-1 mb-1 flex flex-row text-md">
                ...
                <div class="w-4/5 pr-8 ml-2 my-1 flex flex-col">
                  ...
                  <span class="italic text-gray-600 mt-1"><span class="font-bold not-italic">AI: </span>"{criterion.to_review.explanation}"</span>
                </div>
                
                <!-- Answer Buttons, align right -->
                <div class="w-1/5 my-1 mr-2 flex flex-row justify-end space-x-1">
